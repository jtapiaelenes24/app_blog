    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center">
                <a href="">
                    <p class="text-gray-500 bg-white hover:text-gray-700 text-xl mb-0">Mi Blog Personal</p>
                </a>
            </div>
...
<?php /**PATH C:\wamp64\www\curso_laravel\jetstream\app_blog\resources\views/navigation-menu.blade.php ENDPATH**/ ?>